...
<head>
  ...
  <link rel="stylesheet" href="../../css/shoes/shoes.css">
  <!-- <link rel="stylesheet" href="../../css/shoes/shoes.scss"> -->
  ...
  <section class="banner-part">
    ...
    <div class="mycontainer">
      <div class="wow slideInLeft">
        <div class="items">
          <h1>Shoes</h1>
          <h2>Shoes made ready for the dance floor <br> whether you shimmy or shuffle it</h2>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="items">
        <div class="row mt-2 mb-5">
            <?php
            $con = getConnection();
            $sql = "select * from supplier_product where producttype='Shoe' and status='permitted'";
          ...
          <div class="col-md-4">
            <div class="cards">
            <form action="selectedShoe/selectedShoe.php" method="post">
