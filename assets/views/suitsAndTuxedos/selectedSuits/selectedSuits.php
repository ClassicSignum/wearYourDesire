...
if(!isset($_SESSION['login-email'])){
    ...
    header('location: ../suitsAndTuxedos.php');    
}
else{
...
<head>
    ...
    <!-- <link rel="stylesheet" href="../../../css/shoes/selectedShoe/selectedShoe.scss"> -->
    <link rel="stylesheet" href="../../../css/all.min.css">
    <title>Suits & Tuxedo!</title>
</head>
                  ...
                  <ul class="navbar-nav m-auto">
                      ...
                      <li class="dhover1 nav-item dropdown pr-4 pb-0">
                          ...
                          <div class="dropdown-menu bg-dark dmenu1" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="../suitsAndTuxedos.php">SUITS &
                                  TUXEDOS</a>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <ul class="collapsible">
                        <li>
                            <div class="collapsible-header"><i class="fas fa-info-circle"></i>Details <i
                                    class="fas fa-arrow-down ml-auto"></i></div>
                            <div class="collapsible-body"><span><?=$prodinfo['productdetails']?></span></div>
                        </li>
                        <li>
                            <div class="collapsible-header"><i class="fas fa-file-alt"></i>Description <i
                                    class="fas fa-arrow-down ml-auto"></i></div>
                            <div class="collapsible-body"><span><?=$prodinfo['productdesc']?></span></div>
                        </li>
                        <li>
                            <div class="collapsible-header"><i class="fas fa-expand-arrows-alt"></i>Size <i
                                    class="fas fa-arrow-down ml-auto"></i></div>
                ...
                <div class="modal-body">
                    <form action="../../../php/customerCart.php" method="post">
                       ...
                       <input type="hidden" name="productpic" value="<?=$prodinfo['productpic'] ?>">
                        ...
                        <!-- <i class="btn btn-outline-secondary mt-3">Rent this now</button> -->
                    </form>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="product-price" value="<?=$prodinfo['productprice'] ?>">
                       ...
                       <input type="hidden" name="productpic" value="<?=$prodinfo['productpic'] ?>">
                        ...
                        <!-- <button class="btn btn-outline-secondary mt-3">Buy this now</button> -->
                    </form>
                </div>
