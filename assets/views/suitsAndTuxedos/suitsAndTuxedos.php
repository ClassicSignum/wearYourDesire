...
<head>
  ...
  <link rel="stylesheet" href="../../css/suitsAndTuxedos/suitsAndTuxedos.css">
  
  <!-- <link rel="stylesheet" href="../../css/suitsAndTuxedos/suitsAndTuxedos.scss"> -->
...
<section class="banner-part">
  ...
  <div class="mycontainer">
      <div class="wow slideInLeft">
          <div class="items">
              <h1>Suits & Tuxedos</h1>
              <h2>Select a suit or tuxedo to start building your look</h2>
          </div>
      </div>
  </div>
    ...
    <div class="container">
        <div class="items">
            <div class="row mt-2 mb-5">
                <?php
                $con = getConnection();
                $sql = "select * from supplier_product where producttype='Suits & Tuxedo' and status='permitted'";
                ...
                while($row= mysqli_fetch_assoc($result)){
                  ...
                  <div class="col-md-4">
                  <div class="cards">
                  <form action="selectedSuits/selectedSuits.php" method="post">
