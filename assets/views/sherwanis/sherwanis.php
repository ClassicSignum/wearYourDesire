...
<head>
  ...
  <link rel="stylesheet" href="../../css/sherwanis/sherwanis.css">
  <!-- <link rel="stylesheet" href="../../css/sherwanis/sherwanis.scss"> -->
  ...
  <section class="gallery-part">
    ...
    <div class="container">
        <div class="items">
            ...
            <?php
            $con = getConnection();
            $sql = "select * from supplier_product where producttype='Sherwani' and status='permitted'";
          ...
          <div class="col-md-4">
            <div class="cards">
            <form action="selectedSherwani/selectedSherwani.php" method="post">
