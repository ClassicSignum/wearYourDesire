                  ...
                  <ul class="navbar-nav m-auto">
                      ...
                      <li class="dhover1 nav-item dropdown pr-4 pb-0">
                          ...
                          <div class="dropdown-menu bg-dark dmenu1" aria-labelledby="navbarDropdown">
                              ...
                              <a class="dropdown-item" href="../sherwanis.php">SHERWANIS</a>
  ...
  <!-- header part ends -->
    ...
    <section class="product-part">
        ...
        <div class="container text-center">
            ...
            <h5 class=" text-uppercase"><?php  echo $productTitle  ?></h5>
            <div class="row">
                <div class="col-md-7">
                ...
                <form action="../../../php/customerCart.php" method="post">
                    <input type="hidden" name="product-price" value="<?=$prodinfo['productprice'] ?>">
                       ...
                       <input type="hidden" name="productpic" value="<?=$prodinfo['productpic'] ?>">
                        ...
                        <input type="submit" class="btn btn-outline-secondary mt-3" name="buy" value="Rent this now">
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <form action="../../../php/customerCart.php" method="post">
                       ...
                       <input type="hidden" name="productpic" value="<?=$prodinfo['productpic'] ?>">
                        ...
                        <input type="submit" class="btn btn-outline-secondary mt-3" name="rent" value="Buy this now">
                    </form>
                </div>
